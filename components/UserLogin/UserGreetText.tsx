...
const UserGreetText = ({ user }: UserGreetTextProps) => {
  ...
  return (
    <div className="flex mt-[7px] items-center gap-2 cursor-pointer backdrop:blur-sm p-2 rounded-xl bg-gray-100 hover:bg-slate-200 transition-all duration-200 ease-in-out">
      {avatarUrl ? (
        <Image
          src={avatarUrl}
          alt={fullName}
