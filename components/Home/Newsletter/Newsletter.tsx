...
const Newsletter = () => {
  return (
    <div className="bg-black pt-16 pb-20 flex items-center justify-center w-full flex-col">
      ...
      <div className="w-full">
        <input
          type="text"
          className="px-6 py-3.5 bg-white mt-8 w-[95%] sm:w-[80%] md:w-[60%] lg:w-[40%] mx-auto block rounded-lg outline-none"
          placeholder="Email"
        />
